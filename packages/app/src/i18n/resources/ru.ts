  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        markAllReviewed: "Отметить все файлы как просмотренными",
        ...
        markLineReviewed: "Отметить строку {{line}} как просмотренной",
        markLineUnreviewed: "Отметить строку {{line}} как непросмотренной",
