...
export default function MRTrackerRoute() {
  const params = useLocalSearchParams<{ tab?: string; mr?: string; focus?: string }>();
  ...
  const focusRevision = typeof params.focus === "string" ? params.focus : undefined;
  return <MRTrackerScreen tab={tab} focusId={focusId} focusRevision={focusRevision} />;
}
