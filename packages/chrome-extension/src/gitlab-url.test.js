...
describe("GitLab MR URLs", () => {
  ...
  it("builds stable, origin-scoped registration data", () => {
    expect(originPattern("https://gitlab.example.com")).toBe("https://gitlab.example.com/*");
    expect(registrationId("https://gitlab.example.com")).toBe(
      registrationId("https://gitlab.example.com"),
    );
  });
});
