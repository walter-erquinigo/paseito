#!/usr/bin/env python3
"""Discover the next local Paseito maintenance candidate using GitHub's API."""
...
def main() -> int:
    ...
    source_version = str(json.loads(args.package.read_text(encoding="utf-8"))["version"])
    ...
    values = {
        ...
        "old_upstream_commit": str(metadata["upstreamCommit"]),
